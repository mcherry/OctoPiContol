...
def main():
	...
	if screensaver_on is False:
            ...
            infoLine1 = font.render("  [ Extruder: " + ext_f.ljust(3) + degree_symbol + " F / " + `ext`.ljust(3) + degree_symbol + " C - Bed: " + bed_f.ljust(3) + degree_symbol + " F / " + `bed`.ljust(3) + degree_symbol + " C ]", True, (255, 255, 255))
            infoLine2 = font.render("  [ Target:   " + ext_target_f.ljust(3) + degree_symbol + " F / " + `ext_target`.ljust(3) + degree_symbol + " C - Target: " + bed_target_f.ljust(3) + degree_symbol + " F / " + `bed_target`.ljust(3) + degree_symbol + " C ]", True, (255, 255, 255))

...
def main():
	...
	if screensaver_on is False:
            ...
            infoLine1 = font.render("  [ extruder: " + ext_f.rjust(3) + degree_symbol + "F / " + ext_c.rjust(3) + degree_symbol + "C     bed:  " + bed_space + "   " + bed_f.rjust(3) + degree_symbol.replace(' ', '') + "F / " + bed_c.rjust(3).replace(' ', '') + degree_symbol + "C ]", True, (255, 255, 255))
            infoLine2 = font.render("  [ target:   " + ext_target_f.rjust(3) + degree_symbol + "F / " + ext_target_c.rjust(3) + degree_symbol + "C     target: " + ext_space + " " + bed_target_f.rjust(3).replace(' ', '') + degree_symbol + "F / " + bed_target_c.rjust(3) + degree_symbol + "C ]", True, (255, 255, 255))
